<?php
/**
 * wlru functions and definitions.
 *
...
function wlru_setup() {
	 ...
	 * If you're building a theme based on wlru, use a find and replace
	 * to change 'wlru' to the name of your theme in all the template files.
	 */
	...
	add_theme_support( 'custom-background', apply_filters( 'wlru_custom_background_args', array(
 ...
 */
function wlru_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'wlru_content_width', 640 );
}
add_action( 'after_setup_theme', 'wlru_content_width', 0 );
