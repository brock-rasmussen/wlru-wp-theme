<?php
add_action( 'after_setup_theme', 'wlru_customize_test_page' );
function wlru_customize_test_page() {
      ...
      '<div>',
        '<div class="btn-group btn-group-justified" role="group" aria-label="Justified button group with nested dropdown">',
          ...
          '<div class="btn-group" role="group">',
            '<a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false"> Dropdown <span class="caret"></span>',
            '</a>',
            '<ul class="dropdown-menu">',
              '<li><a href="#">Action</a></li>',
              '<li><a href="#">Another action</a></li>',
  ...
  if ( null == get_page_by_title( 'Bootstrap' ) ) {
